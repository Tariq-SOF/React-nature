...
function Mountains() {
  return (
    <div className="w-full	h-screen bg-[url('https://images.pexels.com/photos/10801300/pexels-photo-10801300.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')]  bg-cover bg-center flex flex-col justify-between items-center">
    <div className='flex flex-col items-center '>
    <h1 className='text-2xl font-bold text-slate-800 mt-5'>MOUNTAINS</h1>
    <h1 className='text-2xl  font-bold text-slate-800 mt-2 text-center'> Characterized by high and rugged landscapes,<br/>including mountain ranges and peaks.</h1>
</div>
