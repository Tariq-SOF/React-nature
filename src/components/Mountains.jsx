...
function Mountains() {
  return (
    <div class="w-full	h-[96vh] bg-[url('https://images.pexels.com/photos/10801300/pexels-photo-10801300.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')]  bg-cover bg-center flex flex-col justify-between items-center">
