...
function Plains() {
  return (<>
    <div class="w-full h-screen bg-[url('https://images.pexels.com/photos/15986262/pexels-photo-15986262/free-photo-of-clouds-over-transmission-towers-on-fields.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')]  bg-cover bg-center flex flex-col justify-between items-center">
    <div className='flex flex-col items-center '>
    <h1 className='text-2xl font-bold text-slate-800 mt-5'>PLAINS</h1>
    <h1 className='text-2xl  font-bold text-slate-800 mt-1 text-center'>Featuring flat and open terrains, with fertile soil<br/> suitable for agriculture.</h1>
</div>
