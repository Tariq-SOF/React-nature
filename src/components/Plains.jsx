...
function Plains() {
  return (
    <div class="w-full	h-[96vh] bg-[url('https://images.pexels.com/photos/15986262/pexels-photo-15986262/free-photo-of-clouds-over-transmission-towers-on-fields.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')]  bg-cover bg-center flex flex-col justify-between items-center">
