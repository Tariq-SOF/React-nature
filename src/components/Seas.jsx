...
function Seas() {
  return (
    <>
    <div className="w-full h-screen bg-[url('https://images.pexels.com/photos/1544376/pexels-photo-1544376.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')]  bg-cover bg-center flex flex-col justify-between items-center">
    <div className='flex flex-col items-center '>
    <h1 className='text-2xl font-bold text-slate-200 mt-5'>SEAS</h1>
    <h1 className='text-2xl  font-bold text-slate-200 mt-1 text-center'>Spanning large areas of saltwater, surrounded <br/>by land from all directions.</h1>
</div>
