  ...
  return (
   ...
   <Navpar/>
    ...
    <div className='w-full bg-black bg-opacity-50 h-[84vh] flex items-center justify-center '  >
        <div className='w-1/4 h-3/5 bg-white bg-opacity-70 shadow-2xl rounded text-black text-opacity-50 flex flex-col justify-around items-center' >
            ...
            <div>
            <a href="/Homepagee"><button className='bg-black bg-opacity-80 text-white text-opacity-70 font-bold w-32 p-1 rounded-lg cursor-pointer'> SignIn</button></a>
            </div>
        </div >            
    </div>
    </div>
